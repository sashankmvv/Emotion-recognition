...
X_dict=open_pickle("https: // drive.google.com/file/d/1nAjHb2SioYCmEGsSW52t1p8iWcU_Yk6W/view?usp=sharing")
y = open_pickle("https: // drive.google.com/file/d/1nAjHb2SioYCmEGsSW52t1p8iWcU_Yk6W/view?usp=sharing")
...
dataset_dict['emotion_alias'] = dict((e, i) for i, e in dataset_dict['emotion_id'].items())
...
X_train, X_test, y_train, y_test = train_test_split(X, y, train_size=0.9, shuffle=True, random_state=69)
